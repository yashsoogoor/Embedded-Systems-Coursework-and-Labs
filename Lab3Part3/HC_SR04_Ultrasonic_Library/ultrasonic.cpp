 #include "ultrasonic.h"
    ...
    ultrasonic::ultrasonic(PinName trigPin, PinName echoPin, float updateSpeed, float timeout, void onUpdate(double))
    ...
    void ultrasonic::_updateDist()
    {
        ...
        _distance = (end - start)/6.000*0.00328084;       
        _tout.detach();
    ...
    double ultrasonic::getCurrentDistance(void)
    {
        return _distance;
    }
    ...
    void ultrasonic::attachOnUpdate(void method(double))
    {
